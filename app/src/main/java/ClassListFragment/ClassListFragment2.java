...
public class ClassListFragment2 extends Fragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ViewGroup rootView = (ViewGroup)inflater.inflate(R.layout.fragment_class_list2, container, false);
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        VideoPagerAdapterForFragment2 adapter = new VideoPagerAdapterForFragment2(getChildFragmentManager());
    ...
    class VideoPagerAdapterForFragment2 extends FragmentStatePagerAdapter {
        ArrayList<Fragment> videos = new ArrayList<Fragment>();

        public VideoPagerAdapterForFragment2(@NonNull FragmentManager fm) {
            super(fm);
        }
